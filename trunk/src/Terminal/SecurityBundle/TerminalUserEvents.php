 ...
 */
final class TerminalUserEvents
{
    /**
    ...
    /**
     * The ACTIVATION_SUCCESS event occurs when the registration form is submitted successfully.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a FOS\UserBundle\Event\FormEvent instance.
     */
    const ACTIVATION_SUCCESS = 'terminal_user.activation.success';
